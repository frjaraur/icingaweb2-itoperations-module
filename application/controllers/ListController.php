...
class ITOperations_ListController extends Controller
{
    /**
...
//        $this->view->orientationBox = $orientationBox;
    ...
    public function itoperationsservicegroupsAction()
    {
        $this->addTitleTab(
            'servicegroups',
        ...
        $query = $this->backend->select()->from('servicegroup', array(
        		'servicegroup_alias',
        		'servicegroup_name',
        		//'services_total',
        ));
...
//        $this->applyRestriction('monitoring/filter/objects', $query);
    ...
    public function servicesoperationalstateAction()
    {
    	// Handle soft and hard states
    	if (strtolower($this->params->shift('stateType', 'soft')) === 'hard') {
    		$stateColumn = 'service_hard_state';
